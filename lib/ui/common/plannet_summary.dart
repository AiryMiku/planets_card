...
import 'package:planets_card/detail_page.dart';
import 'package:planets_card/model/planet.dart';
import 'package:planets_card/ui/common/separator.dart';
import 'package:planets_card/ui/text_style.dart';
...
class PlanetSummary extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final planetCardContent = new Container(
      margin: new EdgeInsets.fromLTRB(horizontal ? 76.0 : 16.0, horizontal ? 14.0 : 42.0, 16.0, 16.0),
